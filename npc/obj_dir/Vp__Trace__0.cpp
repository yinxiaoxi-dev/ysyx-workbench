...
void Vp___024root__trace_chg_sub_0(Vp___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vp___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vp___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vp___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vp___024root__trace_chg_sub_0(Vp___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vp___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgBit(oldp+3,(vlSelf->g));
    bufp->chgBit(oldp+4,(vlSelf->k));
}

void Vp___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vp___024root__trace_cleanup\n"); );
    // Init
    Vp___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vp___024root*>(voidSelf);
    Vp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
